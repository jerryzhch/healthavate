...
const HomePage = () => {
                ...
                },
                {
                    ...
                    onClick: () => {
                        if (appState == AppState.ChooseDestination) {
                            setElevatorDestination(val);
                            makeElevatorReservation(val);
                        }
    ...
    const makeElevatorReservation = useCallback((destination) => {
    ...
    return (
        <Page name="home" className="homePage">
            ...
            {/* Page content */}
            {assignedCar && <AssignedCarPopover selectedElevator={activeButton} assignedCar={assignedCar}
